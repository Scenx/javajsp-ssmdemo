...
<c:set var="picPath" value="http://211.159.170.18:8080/ssmImg"></c:set>
...
<head>
    ...
    <script type="text/javascript">
        function submitImgSize1Upload() {
            ...
            var option = {
                type: 'POST',
                url: '${pageContext.request.contextPath }/upload/uploadPic.scen',
                dataType: 'text',
                data: {
...
<body>
<form id="itemForm" action="${pageContext.request.contextPath }/items/saveOrUpdate.scen" method="post">
